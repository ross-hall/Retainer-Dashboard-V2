# RS Retainer Tracker — Codex Context

## Project overview
Single-file HTML app: `index.html` (~4,810 lines) — note: this AGENTS.md previously referred to it as `rs-retainer-tracker.html`; the file on disk is `index.html`, same structure described below.
